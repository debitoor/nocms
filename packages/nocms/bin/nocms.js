...
let main = (() => {
	var _ref = _asyncToGenerator(function* () {
		try {
			...
			// Load config rc file
			const config = yield (0, _config2.default)();
			...
			const pluginActivationContext = (0, _createPluginActivationContext2.default)(inDir, outDir, registerResourceProvider, config);
